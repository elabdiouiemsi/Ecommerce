...
namespace ecommerce.Controllers
{
    public class CommandeItemController : Controller
    {
        ...
        public CommandeItemController(ApplicationDbContext context)
        {
            _context = context;
        }
